...
public class MainFrame implements ActionListener {
    ...
    JPanel panel1,panel2,panel3, projPanel;
    JFrame mainFrame, secondFrame, logInFrame, BCSFrame;
    ...
    MainFrame(){
        ...
        BCSFrame = new JFrame("BugConSys");
        BCSFrame.setBounds(60,7,300,300);
        ...
        projPanel.setLayout(null);
        projPanel.setSize(300,300);
        ...
        BCSFrame.setDefaultCloseOperation(BCSFrame.EXIT_ON_CLOSE);
        BCSFrame.setContentPane(projPanel);
        ...
        if (ae.getSource() == enterLogButton){
            ...
            String password = pasF.getText();
            String user = findUser(login);
            if (!user.equals("")){
        ...
        if (ae.getSource() == registerButton) {
            ...
            if (!userLine.equals("")) {
                ...
                if (pass.equals(userLine.substring(userLine.indexOf("#")))) {
                    ...
                    //System.out.println(userLine.substring(userLine.indexOf("#")));
